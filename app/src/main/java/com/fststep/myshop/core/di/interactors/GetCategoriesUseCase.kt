...
class GetCategoriesUseCase @Inject constructor(private val apiService: ApiService) {

    operator fun invoke() = flow<State<CategoryResponse>> {
        apiService.getCategories().run {
