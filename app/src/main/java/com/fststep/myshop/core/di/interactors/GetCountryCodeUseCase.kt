...
class GetCountryCodeUseCase @Inject constructor(private val apiService: ApiService) {

    operator fun invoke() = flow<State<CountryCodeResponse>> {
        apiService.getCountryCode().run {
