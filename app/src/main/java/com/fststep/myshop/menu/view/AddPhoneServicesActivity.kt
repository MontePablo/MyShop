...
import com.fststep.myshop.databinding.ActivityAddPhoneServiceBinding
 ...
 */
class AddPhoneServicesActivity : AppCompatActivity(), MenuEditListener {

    private lateinit var mBinding: ActivityAddPhoneServiceBinding

    private var products: ArrayList<Product> = arrayListOf()

    private lateinit var adapter: PhoneServiceAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding = DataBindingUtil.setContentView(this, R.layout.activity_add_phone_service)
    ...
    private fun isValid(): Boolean {
        ...
        when {
            ...
            mBinding.etProductDescription.text?.trim().isNullOrEmpty() -> {
                result = false
                mBinding.tlProductDescription.error = getString(R.string.lbl_required)
            }
    ...
    private fun cleanError() {
        ...
        mBinding.tlProductDescription.error = null
    ...
    private fun addProductToMenu() {
        ...
        val newProduct = Product(
            ...
            description = mBinding.etProductDescription.text?.trim().toString(),
            weight = null,
            unit = null,
    ...
    private fun isUnsavedData(): Boolean {
        return products.isNotEmpty() || mBinding.etProductName.text?.trim().toString().isNotEmpty() ||
            mBinding.etProductDescription.text?.trim().toString().isNotEmpty() ||
    ...
    private fun addMoreProducts() {
        ...
        mBinding.etProductDescription.text?.clear()
