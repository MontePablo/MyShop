 ...
 */
class PhoneServiceAdapter(private var products: ArrayList<Product>, private var menuEditListener: MenuEditListener) : BaseProductAdapter() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ProductMenuMode.MODE_NORMAL.value -> {
                val view = LayoutInflater.from(parent.context).inflate(R.layout.layout_add_phone_service_item, parent, false)
                NormalViewHolder(view)
            }
            else -> {
                val view = LayoutInflater.from(parent.context).inflate(R.layout.layout_edit_phone_item, parent, false)
                EditViewHolder(view)
            }
        }
    }
                ...
                btUpdateProduct.setOnClickListener {
                    ...
                    if (isValid()) {
                        ...
                        val updatedProduct = Product(
                            ...
                            description = etProductDescription.text?.trim().toString(),
                            weight = null,
    ...
    inner class NormalViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val productDescription: AppCompatTextView = itemView.findViewById(R.id.tvDescription)
    ...
    inner class EditViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val tlProductDescription: TextInputLayout = itemView.findViewById(R.id.tlProductDescription)
        val etProductDescription: TextInputEditText = itemView.findViewById(R.id.etProductDescription)
        ...
        fun isValid(): Boolean {
            ...
            when {
                ...
                etProductDescription.text?.trim().isNullOrEmpty() -> {
                    result = false
                    tlProductDescription.error = context?.getString(R.string.lbl_required)
                }
        ...
        fun cleanError() {
            ...
            tlProductDescription.error = null
